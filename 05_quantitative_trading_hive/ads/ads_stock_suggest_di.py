   ...
   spark.sql(
       ...
       tmp_ads_04 as (
                      select *,
                             ...
                             -- 权重 
                             dense_rank()over(partition by td order by dr_z_total_market_value+dr_pe_ttm+dr_turnover_rate+dr_sub_factor_score,volume_ratio_1d) as stock_strategy_ranking
                      from tmp_ads_03
       )
       select trade_date,
              stock_code,
