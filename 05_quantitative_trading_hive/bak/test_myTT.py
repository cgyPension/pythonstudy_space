...
# python /opt/code/pythonstudy_space/05_quantitative_trading_hive/bak/test_myTT.py
# nohup python /opt/code/05_quantitative_trading_hive/bak/test_spark.py >> my.log 2>&1 &
# spark-submit /opt/code/pythonstudy_space/05_quantitative_trading_hive/bak/test_myTT.py
