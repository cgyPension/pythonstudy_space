...
# python /opt/code/pythonstudy_space/05_quantitative_trading_hive/hc/rps_xsz_hsl.py 20221202 20221226 2 3 7777
# python /opt/code/pythonstudy_space/05_quantitative_trading_hive/hc/rps_xsz_hsl.py 20221202 20221226 5 3 8888
if __name__ == '__main__':
    ...
    bt_rank.hc('行业rps+小市值+换手率',pd_df, start_date, end_date, end_date_5, hold_day, hold_n, port=port)
    end_time = time.time()
