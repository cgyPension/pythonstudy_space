...
# python /opt/code/pythonstudy_space/05_quantitative_trading_hive/hc/20230123_量价齐跌.py 20220112 20230120 2 3 7777
# python /opt/code/pythonstudy_space/05_quantitative_trading_hive/hc/20230123_量价齐跌.py 20220112 20230120 5 3 8888
    ...
    sql = """
       ...
       tmp_ads_02 as (
        ...
        where stock_name not rlike 'ST'
            and nvl(stock_label_names,'保留null') rlike '连续3天量价齐跌'
