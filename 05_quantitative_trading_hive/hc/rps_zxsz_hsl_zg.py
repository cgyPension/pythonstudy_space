...
# python /opt/code/pythonstudy_space/05_quantitative_trading_hive/hc/rps_zxsz_hsl_zg.py 20221202 20221226 2 3 7777
# python /opt/code/pythonstudy_space/05_quantitative_trading_hive/hc/rps_zxsz_hsl_zg.py 20221202 20221226 5 3 8888
if __name__ == '__main__':
    ...
    sql = """
       ...
       tmp_ads_04 as (
                      select *,
                             '行业rps+z小市值+换手率+主观因子' as stock_strategy_name,
    ...
    bt_rank.hc('行业rps+z小市值+换手率+主观因子',pd_df, start_date, end_date, end_date_5, hold_day, hold_n, port=port)
    end_time = time.time()
