...
# python /opt/code/pythonstudy_space/05_quantitative_trading_hive/hc/2ljqs_zxsz_hsl.py 20210101 20230105 2 3 7777
# python /opt/code/pythonstudy_space/05_quantitative_trading_hive/hc/2ljqs_zxsz_hsl.py 20210101 20230105 5 3 8888
if __name__ == '__main__':
    ...
    sql = """
            ...
            where td between '%s' and '%s'
                    ...
                    and stock_label_names rlike '连续2天量价齐升'
            ),
            tmp_ads_02 as (
            --去除or 停复牌
            select *
    ...
    bt_rank.hc('连续2天量价齐升+z小市值+换手率',pd_df, start_date, end_date, end_date_5, hold_day, hold_n, port=port)
    end_time = time.time()
