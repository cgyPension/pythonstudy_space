...
# python /opt/code/pythonstudy_space/05_quantitative_trading_hive/hc/xsz_pettm_hsl.py 20210101 20221227 2 3 7777
# python /opt/code/pythonstudy_space/05_quantitative_trading_hive/hc/xsz_pettm_hsl.py 20210101 20221227 5 3 8888
if __name__ == '__main__':
    ...
    bt_rank.hc('小市值+市盈率TTM+换手率',pd_df, start_date, end_date, end_date_5, hold_day, hold_n, port=port)
    end_time = time.time()
