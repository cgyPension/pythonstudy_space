...
from stockui.view.DwBottomRps import DwBottomRps
from stockui.view.BlockIndWindow import BlockIndWindow
...
class IndustryTabWidget(BaseTabWidget,UiDataUtils):
    ...
    def _init_view(self):
        ...
        # 板块子窗口
        self.child_window = BlockIndWindow()
    ...
    def _load_table_view(self, date):
        ...
        df = self.get_all_plate(date_str, date_str)
        if df.empty:
