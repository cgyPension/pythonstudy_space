...
def get_data():
    ...
    # pa 参数灵活变动
    pa = [
        ['小市值+市盈率TTM+换手率', sql_01, '20221001', '20221210', [2, 5], 3]
        # ['小市值+市盈率TTM+换手率', sql_01, '20210101', '20221210', [2, 5], 3, True],
        # ['小市值+PEG+换手率', sql_02, '20210101', '20221210', [2, 5], 3, True],
        # ['行业rps+小市值+换手率', sql_03, '20221202', '20221219', [2, 5], 3, True],
        # ['行业rps+小市值+换手率', sql_04, '20221202', '20221219', [2, 5], 3, True]
    ]
    for (strategy_name,sql,start_date, end_date, (hold_day_a,hold_day_b), hold_n) in pa:
        ...
        rt_list.append([strategy_name,pd_df,start_date, end_date, end_date_5,hold_day_a, hold_n])
        rt_list.append([strategy_name,pd_df,start_date, end_date, end_date_5,hold_day_b, hold_n])
...
if __name__ == '__main__':
    ...
    bt_rank.mu_hc(pa_group,process_num)
    end_time = time.time()
