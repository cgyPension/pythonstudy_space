...
Subject = '量化投资操作'
sender_show = ''
# recipient_shows = ['蔡广源','梁小杰','秦晋隆','侯汉炜','夏伟豪']
# to_addrs = ['2855227591@qq.com','amazy.jie@qq.com','1620157829@qq.com','463747069@qq.com','gg201008139066@gmail.com'] # 收件人邮箱账号(这里发自己) list 可放批量
recipient_shows = ['蔡广源']
to_addrs = ['2855227591@qq.com'] # 收件人邮箱账号(这里发自己) list 可放批量
...
def send_mail(df,txt=''):
    ...
    mail_html =  '''
        ...
        <p><font size="3" color="#525252"><b>股票推荐短线策略：2~5天，合理选3~5设置权重、轮动。在9点15到9点25以涨停价挂单，这样能以开盘价成交；2点57挂跌停价，这样能以收盘价成交。方便事后统计。'''+ txt +'''
        </b></font></p>
        '''+ df_html +'''
        </body>
        </html>'''
