...
# python /opt/code/pythonstudy_space/05_quantitative_trading_hive/dwd/dwd_stock_quotes_stand_di.py update 20210101 20211231
...
# python /opt/code/pythonstudy_space/05_quantitative_trading_hive/dwd/dwd_stock_quotes_stand_di.py update 20230101 20230120
